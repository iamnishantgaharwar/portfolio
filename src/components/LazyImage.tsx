			...
			try {
				...
				switch (src) {
					case 'wp-loyalty-img1':
						importedImage = await import(
							'../assets/images/wp-loyalty-img1.webp'
						);
						break;
					case 'rtcampimg1':
						importedImage = await import(
							'../assets/images/rtcampimg1.webp'
						);
						break;
					case 'wp2':
						importedImage = await import(
							'../assets/images/wp2.webp'
						);
						break;
					case 'wp1':
						importedImage = await import(
							'../assets/images/wp1.webp'
						);
						break;
					case 'wp3':
						importedImage = await import(
							'../assets/images/wp3.webp'
						);
						break;
					case 'rtcampimg2':
						importedImage = await import(
							'../assets/images/rtcampimg2.webp'
						);
						break;
					default:
