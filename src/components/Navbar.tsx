...
const Navbar = () => {
  return (
    <>
    <nav className=" flex justify-end items-center h-20 py-[25px] px-5 sm:px-10 text-primary_white font-PoppinsBold">
        ...
        {/* <ul className="flex justify-around items-center">
            ...
            <li className="hidden sm:block px-4 bg-primary_white text-secondary_black p-2 rounded"><a href="/nishantgaharwar.pdf" download>Resume</a></li>
        </ul> */}
    </nav>
    </>
  )
